...
public class ExampleSpecificCalendar {
    public static void main(String[] args) {
        ...
        calendar.add(Calendar.MONTH, -4);
        System.out.println("4 bulan yang akan lalu : " + calendar.getTime());

        // Menampilkan waktu 2 tahun yang lalu 
        calendar.add(Calendar.YEAR, -2);
        System.out.println("2 Tahun yang akan lalu : " + calendar.getTime());
    }
